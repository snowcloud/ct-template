...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClinTemplate.accept_reviews'
        db.add_column('ct_template_clintemplate', 'accept_reviews', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClinTemplate.accept_reviews'
        db.delete_column('ct_template_clintemplate', 'accept_reviews')
    ...
    models = {
        ...
        'ct_template.clintemplatereview': {
            ...
            'review_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 19, 14, 3, 26, 450953)', 'null': 'True'}),
