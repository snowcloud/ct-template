...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ClinTemplate', fields ['_template_id']
        db.delete_unique('ct_template_clintemplate', ['_template_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ClinTemplate', fields ['_template_id']
        db.create_unique('ct_template_clintemplate', ['_template_id'])
    ...
    models = {
        ...
        'ct_groups.ctgroup': {
            ...
            'resource_comment_order': ('django.db.models.fields.CharField', [], {'default': "'newest_top'", 'max_length': '12'}),
        ...
        'ct_template.clintemplate': {
            ...
            '_template_id': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '64', 'blank': 'True'}),
        ...
        'ct_template.clintemplatereview': {
            ...
            'review_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 29, 14, 46, 22, 551850)', 'null': 'True'}),
